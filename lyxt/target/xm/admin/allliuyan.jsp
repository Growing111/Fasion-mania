...
<div style="margin-bottom: 5px;">
    ...
    <table class="layui-table" lay-data="{page:true, id:'idTest'}" lay-filter="demo">
        ...
        <tr>
            ...
            <th lay-data="{field:'name', width:160}">昵称</th>
            <th lay-data="{field:'descrip', width:200}">邮箱</th>
            <th lay-data="{field:'type',width:370}">留言</th>
            <%--<th lay-data="{field:'price', width:150, sort: true}">价格</th>--%>
            <%--<th lay-data="{field:'classify', width:150}">所属类型</th>--%>
            <%--<th lay-data="{field:'wealth', width:135, sort: true}">财富</th>--%>
            <%--<th lay-data="{field:'score', width:80, sort: true, fixed: 'right'}">评分</th>--%>
            <th lay-data="{fixed: 'right', width:265, align:'center', toolbar: '#barDemo'}">操作</th>
        </tr>
        </thead>
        <tr>
            <td>1</td>
            <td>李四</td>
            <td>9792ws@163.com</td>
            <td>人之间任职者价值</td>
            <td></td>
        </tr>
    </table>
